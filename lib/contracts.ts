export const VOTING_ADDRESS = process.env.NEXT_PUBLIC_VOTING_CONTRACT || "0xB7f8BC63BbcaD18155201308C8f3540b07f84F5e";
export const GATEWAY_ADDRESS = process.env.NEXT_PUBLIC_GATEWAY_CONTRACT || "0x610178dA211FEF7D417bC0e6FeD39F05609AD788";
